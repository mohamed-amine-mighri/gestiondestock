...
public class CommandeClientController implements CommandeClientApi {
  ...
  private CommandeClientServ commandeClientService;

  @Autowired
  public CommandeClientController(CommandeClientServ commandeClientService) {
  ...
  public ResponseEntity<CommandeClientDTO> updateEtatCommande(Integer idCommande, EtatCommande etatCommande) {
    return ResponseEntity.ok(commandeClientService.updateEtatCommande(idCommande, etatCommande));
	  ...
	  @Override public ResponseEntity<CommandeClientDTO>
	  updateQuantiteCommande(Integer idCommande, Integer idLigneCommande,
	  BigDecimal quantite) { return
	  ResponseEntity.ok(commandeClientService.updateQuantiteCommande(idCommande,
	  idLigneCommande, quantite)); }
	  
	  @Override public ResponseEntity<CommandeClientDTO> updateClient(Integer
	  idCommande, Integer idClient) { return
	  ResponseEntity.ok(commandeClientService.updateClient(idCommande, idClient));
	  }
	  
	  
	  @Override public ResponseEntity<CommandeClientDTO> updateArticle(Integer
	  idCommande, Integer idLigneCommande, Integer idArticle) { return
	  ResponseEntity.ok(commandeClientService.updateArticle(idCommande,
	  idLigneCommande, idArticle)); }
